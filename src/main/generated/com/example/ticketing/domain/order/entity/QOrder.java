...
public class QOrder extends EntityPathBase<Order> {
    ...
    private static final long serialVersionUID = 1984744292L;
    ...
    public final EnumPath<com.example.ticketing.domain.order.enums.OrderStatus> orderStatus = createEnum("orderStatus", com.example.ticketing.domain.order.enums.OrderStatus.class);
